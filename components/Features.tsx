...
const Features: React.FC = () => {
  ...
  return (
    <section id="features" className="px-6 pt-20 pb-12">
      <h2 className="sr-only">Преимущества</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        {features.map((f, idx) => (
          <div key={idx} className="flex flex-col lg:items-start gap-5 p-8 bg-card border border-primary/5 rounded-[2.5rem] shadow-card transition-all hover:scale-[1.03] hover:shadow-md">
